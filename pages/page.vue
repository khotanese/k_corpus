      ...
      <v-card>
        ...
        <v-card-title class="headline">
            <v-list>
              ...
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Main find spot:&nbsp;</font> {{data_model.main_find_spot}}</v-card-title></v-list-item>
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Specific find spot:&nbsp; </font>{{data_model.specific_find_spot}}</v-card-title></v-list-item>
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Expedition or collection:&nbsp;</font> {{data_model.expedition_or_collection}}</v-card-title></v-list-item>
              ...
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Current location:&nbsp;</font> {{data_model.current_location}}</v-card-title></v-list-item>
              <v-divider></v-divider>
              ...
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Subgenre:&nbsp;</font> {{data_model.subgenre}}</v-card-title></v-list-item>
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Archive:&nbsp;</font> {{data_model.archive}}</v-card-title></v-list-item>
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Title of the work:&nbsp;</font> {{data_model.title}}</v-card-title></v-list-item>
              ...
              <v-list-item><v-card-title class="headline"><font color='#964f4c'>Writing surface:&nbsp;</font> {{data_model.writing_surface}}</v-card-title></v-list-item>
